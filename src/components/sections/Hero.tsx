  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-28 pb-16 md:pt-32 md:pb-20">
      ...
      <div className="z-10 text-center flex flex-col items-center px-5 w-full max-w-6xl mx-auto">
        ...
        >
          <a href={siteConfig.links.whatsappSalesUrl} target="_blank" rel="noopener noreferrer" className="block w-full sm:w-auto">
            <MagneticButton
              variant="primary"
              className="flex items-center justify-center text-lg px-10 py-5 font-bold uppercase tracking-wide w-full z-10 shadow-lg shadow-blue-500/20"
            >
              Contactar por WhatsApp
            </MagneticButton>
          </a>
          <p className="text-sm font-medium text-slate-500 max-w-[200px] sm:max-w-none text-left">Contacta por WhatsApp para agendar una demostración gratuita.</p>
        </motion.div>
