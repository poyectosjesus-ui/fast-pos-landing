    ...
    <section className="relative w-full max-w-6xl mx-auto px-6 py-24 z-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 auto-rows-[minmax(0,1fr)]">
        ...
        <motion.div
            ...
            className="md:col-span-2 h-full rounded-2xl overflow-hidden relative shadow-sm border border-slate-200 min-h-[250px]"
        >
            <img src="https://images.unsplash.com/photo-1578916171728-46686eac8d58?auto=format&fit=crop&q=80&w=1200" alt="Caos en el mostrador" className="absolute inset-0 w-full h-full object-cover opacity-80" />
