...
export const metadata = {
  title: "Punto de Venta para Ferreterías | Fast-POS",
};
  ...
  return (
    <div className="min-h-[80vh] flex flex-col items-center justify-center bg-slate-50 px-6 pt-32">
      <div className="max-w-2xl text-center bg-white p-12 rounded-3xl shadow-xl border border-slate-100">
        ...
        <h1 className="text-4xl font-black text-slate-900 mb-4 tracking-tight">Solución: Ferreterías</h1>
        <p className="text-lg text-slate-600 mb-8 leading-relaxed">
          Administra miles de productos granel, tornillería, y ventas a crédito. Evita el robo hormiga y facilita las cotizaciones a contratistas.
        </p>
