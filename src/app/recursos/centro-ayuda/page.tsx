...
export const metadata = {
  title: "Centro de Ayuda | Fast-POS",
};
  ...
  return (
    <div className="min-h-[80vh] flex flex-col items-center justify-center bg-slate-50 px-6 pt-32">
      <div className="max-w-2xl text-center bg-white p-12 rounded-3xl shadow-xl border border-slate-100">
        ...
        <h1 className="text-4xl font-black text-slate-900 mb-4 tracking-tight">Centro de Ayuda Oficial</h1>
        <p className="text-lg text-slate-600 mb-8 leading-relaxed">
          Respuestas rápidas, manuales de usuario y tutoriales en video para que le saques el 100% de provecho a Fast-POS.
        </p>
